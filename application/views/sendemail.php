    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8" style="margin:0 auto; float:none;">
          ...
          <br />          
          <form method="post" action="http://localhost/Student_Management/index.php/Sendemail/send_email_with_photo" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="image" accept=".doc,.docx, .pdf , .jpg, .png, .jpeg" required />
                </div>
                <div class="form-group">
